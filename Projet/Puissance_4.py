...
def dessiner_jeton(ligne, colonne):
    ...
    (Aidé par : ChatGPT en raison de la complexité des reflets)
    '''
...
def basculer_mode_ia():
    ...
    (Aidé par : ChatGPT en raison de la complexité du bouton notamment)
    '''
    global MODE_IA
    MODE_IA = not MODE_IA
...
def jouer_coup_ia():
    '''
    Fait jouer l'IA.
    (Aidé par : ChatGPT de part la difficulté de créer une IA pouvant défier le joueur)
    '''
